...
import com.decisionanalysis.framework.datasource.DynamicDataSourceContextHolder;
...
public class DataSourceAspect
{
    ...
    @Pointcut("@annotation(com.decisionanalysis.framework.aspectj.lang.annotation.DataSource)")
